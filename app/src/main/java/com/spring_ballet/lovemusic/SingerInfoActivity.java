    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OkHttpUtil.loadData(CommonApis.SINGER_MUSIC_LIST + uid, new OkHttpUtil.OnLoadDataFinish() {
            ...
            public void loadDataFinish(String data) {
                SingerMusicList singerMusicList = JSONObject.parseObject(data, SingerMusicList.class);
                LogUtil.logD(CommonApis.SINGER_MUSIC_LIST + uid + '\n' + singerMusicList.getSonglist().size());
            }
        });
        OkHttpUtil.loadData(CommonApis.SINGER_INFO_API + uid, new OkHttpUtil.OnLoadDataFinish() {
            ...
            public void loadDataFinish(String data) {
                LogUtil.logD(data);
//                SingerInfo singerInfo = JSONObject.parseObject(data, SingerInfo.class);
